...
public class Herramientas {
        ...
        private final String[] dpt = new String[]{"DESCONOCIDO","Psicológia","Medico","Trabajo Social","Mesa receptora","Recepción","Asesor Júridico","Coordinación de trabajo social","Coordinación de Medico","Coordinación Psicológia","Centro de Asistencia Social","Cordinación de Asesor Juridico"};
     ...
     *
     * @param boton
     * @return a Stage variable
     * You also need asign the value to another Stage and call ".close" method
     */
    public void cerrarPantalla(JFXButton boton){
